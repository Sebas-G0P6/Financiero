...
class BaseExternalDbsource(models.Model):
    ...
    def connection_test(self):
        ...
        return notification
        #raise TypeError(_("Connection test succeeded:\n" "Everything seems properly set up!"))
    ...
    def _execute_native(self, query, params, metadata):
        with self.connection_open() as connection:
            cur = connection.cursor()
            cur.execute(query, params)
            cols = []
    ...
    def _execute_pk(self, query, params): 
        with self.connection_open() as connection:
            cur = connection.cursor()
            cur.execute(query, params)
            connection.commit()

    def _execute_blob(self, query,params): 
        with self.connection_open() as connection:
            cur = connection.cursor()
            cur.execute(query,params)
            connection.commit() 
